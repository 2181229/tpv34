		...
		<header>
			...
			<nav class="barre-logo">
				...
				<div class="panier-icone">
					...
					<div class="badge-panier"><?= nbArticlesPanier($detailPanier); ?></div><!-- pour le nombre d'articles à coté de l'icone du panier -->
					...
					<div class="sommaire-panier">
						...
						<div class="ligne2">
							...
							<span class="sous-total montant-fr" id="sous-total-badge">
								<?= sousTotalPanier($detailPanier); ?>
							</span>
						</div>
